...
--
-- Table structure for table `_dynamicparameters`
--

DROP TABLE IF EXISTS `_dynamicparameters`;
...
--
-- Dumping data for table `_dynamicparameters`
--

LOCK TABLES `_dynamicparameters` WRITE;
/*!40000 ALTER TABLE `_dynamicparameters` DISABLE KEYS */;
/*!40000 ALTER TABLE `_dynamicparameters` ENABLE KEYS */;
UNLOCK TABLES;
