...
--
-- Table structure for table `_entitychanges`
--

DROP TABLE IF EXISTS `_entitychanges`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_entitychanges` (
...
--
-- Dumping data for table `_entitychanges`
--

LOCK TABLES `_entitychanges` WRITE;
/*!40000 ALTER TABLE `_entitychanges` DISABLE KEYS */;
/*!40000 ALTER TABLE `_entitychanges` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-08-31  9:05:36
