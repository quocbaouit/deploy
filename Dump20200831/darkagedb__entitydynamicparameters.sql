...
--
-- Table structure for table `_entitydynamicparameters`
--

DROP TABLE IF EXISTS `_entitydynamicparameters`;
...
--
-- Dumping data for table `_entitydynamicparameters`
--

LOCK TABLES `_entitydynamicparameters` WRITE;
/*!40000 ALTER TABLE `_entitydynamicparameters` DISABLE KEYS */;
/*!40000 ALTER TABLE `_entitydynamicparameters` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-08-31  9:05:30
