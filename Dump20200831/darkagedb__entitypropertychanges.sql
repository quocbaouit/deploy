...
--
-- Table structure for table `_entitypropertychanges`
--

DROP TABLE IF EXISTS `_entitypropertychanges`;
...
--
-- Dumping data for table `_entitypropertychanges`
--

LOCK TABLES `_entitypropertychanges` WRITE;
/*!40000 ALTER TABLE `_entitypropertychanges` DISABLE KEYS */;
/*!40000 ALTER TABLE `_entitypropertychanges` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-08-31  9:05:17
