...
--
-- Table structure for table `_notificationsubscriptions`
--

DROP TABLE IF EXISTS `_notificationsubscriptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_notificationsubscriptions` (
  `Id` char(36) NOT NULL,
...
--
-- Dumping data for table `_notificationsubscriptions`
--

LOCK TABLES `_notificationsubscriptions` WRITE;
/*!40000 ALTER TABLE `_notificationsubscriptions` DISABLE KEYS */;
/*!40000 ALTER TABLE `_notificationsubscriptions` ENABLE KEYS */;
UNLOCK TABLES;
