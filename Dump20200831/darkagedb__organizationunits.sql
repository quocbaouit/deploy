...
--
-- Table structure for table `_organizationunits`
--

DROP TABLE IF EXISTS `_organizationunits`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_organizationunits` (
...
--
-- Dumping data for table `_organizationunits`
--

LOCK TABLES `_organizationunits` WRITE;
/*!40000 ALTER TABLE `_organizationunits` DISABLE KEYS */;
/*!40000 ALTER TABLE `_organizationunits` ENABLE KEYS */;
UNLOCK TABLES;
