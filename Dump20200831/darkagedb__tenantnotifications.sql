...
--
-- Table structure for table `_tenantnotifications`
--

DROP TABLE IF EXISTS `_tenantnotifications`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_tenantnotifications` (
  `Id` char(36) NOT NULL,
  ...
  PRIMARY KEY (`Id`),
  KEY `IX__TenantNotifications_TenantId` (`TenantId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `_tenantnotifications`
--

LOCK TABLES `_tenantnotifications` WRITE;
/*!40000 ALTER TABLE `_tenantnotifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `_tenantnotifications` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-08-31  9:05:40
