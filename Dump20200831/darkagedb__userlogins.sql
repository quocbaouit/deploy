...
--
-- Table structure for table `_userlogins`
--

DROP TABLE IF EXISTS `_userlogins`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_userlogins` (
...
--
-- Dumping data for table `_userlogins`
--

LOCK TABLES `_userlogins` WRITE;
/*!40000 ALTER TABLE `_userlogins` DISABLE KEYS */;
/*!40000 ALTER TABLE `_userlogins` ENABLE KEYS */;
UNLOCK TABLES;
