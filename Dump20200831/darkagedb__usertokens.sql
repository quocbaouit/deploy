...
--
-- Table structure for table `_usertokens`
--

DROP TABLE IF EXISTS `_usertokens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_usertokens` (
...
--
-- Dumping data for table `_usertokens`
--

LOCK TABLES `_usertokens` WRITE;
/*!40000 ALTER TABLE `_usertokens` DISABLE KEYS */;
/*!40000 ALTER TABLE `_usertokens` ENABLE KEYS */;
UNLOCK TABLES;
