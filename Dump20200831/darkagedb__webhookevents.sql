...
--
-- Table structure for table `_webhookevents`
--

DROP TABLE IF EXISTS `_webhookevents`;
...
--
-- Dumping data for table `_webhookevents`
--

LOCK TABLES `_webhookevents` WRITE;
/*!40000 ALTER TABLE `_webhookevents` DISABLE KEYS */;
/*!40000 ALTER TABLE `_webhookevents` ENABLE KEYS */;
UNLOCK TABLES;
