...
--
-- Table structure for table `_webhooksendattempts`
--

DROP TABLE IF EXISTS `_webhooksendattempts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `_webhooksendattempts` (
  `Id` char(36) NOT NULL,
...
--
-- Dumping data for table `_webhooksendattempts`
--

LOCK TABLES `_webhooksendattempts` WRITE;
/*!40000 ALTER TABLE `_webhooksendattempts` DISABLE KEYS */;
/*!40000 ALTER TABLE `_webhooksendattempts` ENABLE KEYS */;
UNLOCK TABLES;
